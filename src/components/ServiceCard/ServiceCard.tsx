...
export const ServiceCard : FC<OwnPropsType> = props => {
  ...
  const findLikeDislike = (arr : Array<any>) => {
  ...
  const goToUser = (ownerId : string | null) => {
    if (uid && ownerId === uid) {
      ...
      <CardActions className={classes.card_action}>
        <div className={classes.like_comment}>
          <IconButton
            ...
            style={findLikeDislike(likes) ? { color: "#7577DF" } : {color : "#757575"}}
            onClick={() => {
              uid && like(id!, uid);
            }}
          >
            <ThumbUpIcon className={classes.likes} />
          </IconButton>
          ...
          <IconButton
            aria-label="add to favorites"
            style={findLikeDislike(dislikes) ? { color: "#7577DF" } : {color : "#757575"}}
            onClick={() => {
              uid && dislike(id!, uid);
            }}
          >
            <ThumbDownIcon className={classes.dislikes} />
          </IconButton>
          <Typography
            gutterBottom
            variant="body2"
